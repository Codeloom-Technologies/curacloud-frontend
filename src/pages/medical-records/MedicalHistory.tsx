...
export default function MedicalHistory() {
  ...
  const [selectedHistory, setSelectedHistory] = useState<
    (typeof medicalHistories)[0] | null
  >(null);
  ...
  const filteredHistories = medicalHistories.filter((history) => {
    const matchesSearch =
      ...
      history.chronicConditions.some((c) =>
        c.condition.toLowerCase().includes(searchTerm.toLowerCase())
      );

    const matchesCondition =
      conditionFilter === "all" ||
      history.chronicConditions.some(
        (c) => c.status.toLowerCase() === conditionFilter
      );
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center pt-2">
                        <span className="text-xs text-muted-foreground">
                          {history.chronicConditions.length} condition
                          {history.chronicConditions.length !== 1 ? "s" : ""} •
                          {history.surgicalHistory.length} procedure
                          {history.surgicalHistory.length !== 1 ? "s" : ""}
                        </span>
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  Patient ID: {selectedHistory?.patientId} •
                                  DOB: {selectedHistory?.dateOfBirth}
                                </DialogDescription>
                              </DialogHeader>
                              {selectedHistory && (
                                <Tabs
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                      <div>
                                        ...
                                        <Table>
                                          ...
                                          <TableBody>
                                            {selectedHistory.chronicConditions.map(
                                              (condition, index) => (
                                                <TableRow key={index}>
                                  ...
                                  <TabsContent value="surgical">
                                    <div>
                                      ...
                                      {selectedHistory.surgicalHistory.length >
                                      0 ? (
                                        <Table>
                                          <TableHeader>
                                            <TableRow>
                                          ...
                                          <TableBody>
                                            {selectedHistory.surgicalHistory.map(
                                              (surgery, index) => (
                                                <TableRow key={index}>
                                                  <TableCell className="font-medium">
                                                    {surgery.procedure}
                                  ...
                                  <TabsContent value="family">
                                    <div>
                                      ...
                                      <div className="space-y-3">
                                        {selectedHistory.familyHistory.map(
                                          (family, index) => (
                                            <div
                                              key={index}
                                  ...
                                  <TabsContent value="immunizations">
                                    <div>
                                      ...
                                      <Table>
                                        ...
                                        <TableBody>
                                          {selectedHistory.immunizations.map(
                                            (vaccine, index) => {
                                              const isDue =
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Add new medical history record for a patient
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <Label htmlFor="historyPatientName">
                            Patient Name *
                          </Label>
                          <Input
