        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="relative rounded-2xl overflow-hidden bg-gradient-hero shadow-strong">
            ...
            <div className="relative p-8 text-white">
              <h1 className="text-3xl font-bold mb-2">Welcome to CuraCloud HMS</h1>
              <p className="text-lg opacity-90 max-w-2xl">
                Streamline your hospital operations with our comprehensive management system. 
                Monitor patient care, schedule appointments, and track key metrics in one place.
              </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-start gap-3 p-3 rounded-lg bg-red-50 border border-red-200">
                  ...
                  <div>
                    <p className="text-sm font-medium text-red-800">Critical Patient Alert</p>
                    <p className="text-xs text-red-600">Room 302 - Patient requires immediate attention</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-orange-50 border border-orange-200">
                  ...
                  <div>
                    <p className="text-sm font-medium text-orange-800">Equipment Maintenance</p>
                    <p className="text-xs text-orange-600">MRI Machine #2 scheduled for maintenance</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <div>
                    <p className="text-sm font-medium text-blue-800">Inventory Low</p>
                    <p className="text-xs text-blue-600">Surgical gloves running low - reorder needed</p>
                  </div>
                </div>
              </CardContent>
            </Card>
